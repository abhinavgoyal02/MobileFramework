...
//		capabilities.setCapability(MobileCapabilityType.NEW_COMMAND_TIMEOUT, CommonUtils.NEW_COMMAND_TIMEOUT);
//		capabilities.setCapability(MobileCapabilityType.DEVICE_READY_TIMEOUT, CommonUtils.DEVICE_READY_TIMEOUT);
//		capabilities.setCapability(MobileCapabilityType.APP_ACTIVITY, CommonUtils.APP_ACTIVITY);
//		capabilities.setCapability(MobileCapabilityType.APP_PACKAGE, CommonUtils.BASE_PKG);
